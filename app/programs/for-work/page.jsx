...
const purposeCards = [
  ...
  {
    title: "Reduce rework",
    description: "Keep output cleaner so you spend less time fixing it later.",
  },
  {
    title: "Keep quality high",
    description:
      "Use the tool without lowering the standard of the work itself.",
  },
];
...
const learnCards = [
  ...
  },
  {
    ...
    description:
      "Shape output so it is easier to scan, edit, and reuse in real work.",
  },
  {
    title: "Use AI in routine workflows",
    description:
      "Build a practical flow for writing, thinking, and checking at work.",
  },
  {
    title: "Review output well",
    description:
      "Know when the answer is enough and when it needs more scrutiny.",
  },
];
...
const moduleCards = [
  {
    ...
    description:
      "Map where AI actually saves time in a real work week and where it should stay out.",
  },
  {
    title: "Drafting",
    description:
      "Use AI to start faster without flattening the voice or the intent.",
  },
  {
    title: "Analysis",
    description:
      "Turn longer or messier input into something easier to use and act on.",
  },
  {
    title: "Quality control",
    description:
      "Keep the output clean enough to trust, edit, and ship with confidence.",
  },
];
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-stretch">
          <div className="fade-up">
            ...
            <h1 className="mt-4 max-w-[10ch] text-[clamp(3rem,6vw,4.9rem)] font-semibold leading-[0.93] tracking-[-0.06em] text-[#1A1A1A]">
              AI for Work with sharper daily output.
            </h1>
