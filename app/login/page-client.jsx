...
const routes = [
  ...
  },
  {
    ...
    description: "A single premium direction and positioning route through Payhip.",
...
export default function LoginPageClient() {
  ...
  const localizedRoutes = routes.map((route) => {
    if (route.title === "Career Intelligence") {
      return { ...route, title: t("products.careerIntelligence", "Career Intelligence") };
    }

    if (route.title === "Consulting") {
      return { ...route, title: t("products.consulting", "Consulting") };
    }

    if (route.description === "AI Foundations, AI for Work, and AI for Business.") {
      return {
        ...route,
        description: `${t("products.aiFoundations", "AI Foundations")}, ${t("products.aiForWork", "AI for Work")}, and ${t("products.aiForBusiness", "AI for Business")}.`,
      };
    }
        ...
        <div className="mt-4 grid grid-cols-1 gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-stretch">
          <div className="fade-up">
            <h1 className="max-w-[10ch] text-[clamp(3rem,6vw,4.75rem)] font-semibold leading-[0.93] tracking-[-0.06em] text-[#1A1A1A]">
              {t("common.login", "Login")} is route access.
            </h1>
