          ...
          <div className="fade-up">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <ButtonLink
                ...
                className="premium-button button-secondary button-standout rounded-[18px] border border-[rgba(198,165,92,0.18)] bg-white/75 px-6 py-4 text-[13px] font-semibold uppercase tracking-[0.16em] text-[#1A1A1A] hover:-translate-y-0.5 hover:border-[rgba(198,165,92,0.32)] hover:bg-white"
              >
                <LocalizedText
          ...
          {consultingPackages.map((pkg, index) => (
            ...
            >
              ...
              <div className="mt-6">
                <ButtonLink
                  href={CONSULTING_INQUIRY_HREF}
                  className="premium-button button-secondary button-standout rounded-[16px] border border-[rgba(168,132,58,0.34)] bg-white/88 px-4 py-3 text-[11px] font-semibold uppercase tracking-[0.14em] text-[#1A1A1A] hover:-translate-y-0.5 hover:border-[rgba(198,165,92,0.32)] hover:bg-white"
                >
                  Request <LocalizedText translationKey="products.consulting" fallback="Consulting" />
                </ButtonLink>
              </div>
