...
const panels = [
  ...
  },
  {
    ...
    description:
      "Pick Foundations for clarity, Work for practice, Business for higher stakes, or Career Intelligence for positioning.",
  },
  {
    title: "Best next move",
    description:
      "Move into the route that fits the decision, then use Consulting only when the call is more selective.",
  },
];
    ...
    <MarketingChrome activeHref="/start">
      ...
      <section className="mx-auto mt-16 max-w-[1200px]">
        <Surface featured className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            <SectionLabel>CHOOSE THE ROUTE</SectionLabel>
